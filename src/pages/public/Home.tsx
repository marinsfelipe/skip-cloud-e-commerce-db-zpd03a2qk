    ...
    <div className="flex flex-col min-h-screen">
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center bg-muted overflow-hidden">
        ...
        <div className="container relative z-10 text-center px-4">
          <h1
            className="text-4xl md:text-6xl font-serif font-bold text-foreground max-w-4xl mx-auto leading-tight animate-fade-in-up"
        ...
        <div className="container px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {FEATURED_LINES.map((line) => (
              ...
              >
                <div className="aspect-[4/3] relative bg-muted flex items-center justify-center text-muted-foreground">
                  Sem imagem
                </div>
                <div className="p-6">
