          ...
          <div>
            ...
            <div className="flex gap-6">
              <a
                ...
                className="text-foreground/70 hover:text-[#E1306C] hover:-translate-y-1 transition-all duration-300 p-2 rounded-full hover:bg-[#E1306C]/10"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground/70 hover:text-[#0A66C2] hover:-translate-y-1 transition-all duration-300 p-2 rounded-full hover:bg-[#0A66C2]/10"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground/70 hover:text-[#25D366] hover:-translate-y-1 transition-all duration-300 p-2 rounded-full hover:bg-[#25D366]/10"
