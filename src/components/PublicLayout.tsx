      ...
      <header className="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-3 ml-2 border-l border-border pl-6">
              <a
                ...
                className="text-foreground/80 hover:text-[#E1306C] transition-colors"
                title="Instagram"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground/80 hover:text-[#0A66C2] transition-colors"
                title="LinkedIn"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <Button asChild className="font-semibold ml-2" variant="default">
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-border bg-background p-4 flex flex-col gap-4 animate-in slide-in-from-top-2">
            ...
            <div className="flex items-center gap-6 py-2 px-2 mt-2 border-t border-border">
              <a
                href={instagramUrl}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="flex gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground hover:text-[#E1306C] hover:-translate-y-1 transition-all duration-300 p-3 rounded-full hover:bg-[#E1306C]/10 ring-1 ring-border hover:ring-[#E1306C]/30 bg-card shadow-sm"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground hover:text-[#0A66C2] hover:-translate-y-1 transition-all duration-300 p-3 rounded-full hover:bg-[#0A66C2]/10 ring-1 ring-border hover:ring-[#0A66C2]/30 bg-card shadow-sm"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-foreground hover:text-[#25D366] hover:-translate-y-1 transition-all duration-300 p-3 rounded-full hover:bg-[#25D366]/10 ring-1 ring-border hover:ring-[#25D366]/30 bg-card shadow-sm"
